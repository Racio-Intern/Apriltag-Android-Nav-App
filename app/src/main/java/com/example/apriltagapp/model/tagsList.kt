...
val tags_1: Array<Tag> = arrayOf(
    ...
    Tag(3, hashMapOf(Pair(2, LinkedTag(2, 3, Direction.BACKWARDS)),Pair(4, LinkedTag(4, 6, Direction.RIGHT)))),
    Tag(4, hashMapOf(Pair(2, LinkedTag(2, 7, Direction.BACKWARDS)), Pair(3, LinkedTag(3, 6, Direction.LEFT)))),
)